...
public:
	...
	virtual std::vector<PathNode*> RequestClosestPath(PathNode* startNode, std::vector<PathNode::Type> endTypes, float& outDist, float agentRadius, const NodeFilter& canTraverse) = 0;
